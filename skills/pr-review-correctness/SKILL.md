...
description: "Run only the correctness reviewer on a PR. Finds bugs, logic errors, edge cases, null safety issues, and race conditions. Invoke with: '/skill:pr-review-correctness 12345'."
argument-hint: "[pr-url-or-number]"
---

# Correctness Review (Single Reviewer)

Run only the `review-correctness` agent against a PR or the current branch diff.
