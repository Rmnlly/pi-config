...
description: "Run only the security reviewer on a PR. Finds vulnerabilities, auth gaps, injection risks, data exposure, and secrets issues. Invoke with: '/skill:pr-review-security 12345'."
argument-hint: "[pr-url-or-number]"
---

# Security Review (Single Reviewer)

Run only the `review-security` agent against a PR or the current branch diff.
